									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<!-- the below code replaced the feedback tab -->
<?php 
$sql ="SELECT id from php_users_login";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$bg=$query->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bg);?></div>
													<div class="stat-panel-title text-uppercase">Regular Customers</div>
												</div>
											</div>
											<a href="regular_customers.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
<!-- //the end of replaced feedback code tab ==regular-customers tab -->
<?php 
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bg);?></div>
													<div class="stat-panel-title text-uppercase">Notification Orders</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Deleted Customers</div>
												</div>
											</div>
